...
public class AirportMap extends PApplet {
	...
	public void setup() {
		...
		map = new UnfoldingMap(this, 200, 20, 900, 900,  new EsriProvider.NatGeoWorldMap());
		...
		HashMap<Integer, AirportMarker> airportsRoutes = new HashMap<Integer, AirportMarker>();
